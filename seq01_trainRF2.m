...
n = 14; %Days of lag for lagged data

    
%Extraction of surface soil moisture and climate variables from nc files,
%nc files contain data for the St. Lawrence Domain (110x69) @30km
...
sw1989 = ncread('/home/sushama/wiki/RF_GEMVal_Project/ERA5_Data/regERA5_SNDT_1989.nc','sd'); %units (m)
sw1990 = ncread('/home/sushama/wiki/RF_GEMVal_Project/ERA5_Data/regERA5_SNDT_1990.nc','sd');
sw1991 = ncread('/home/sushama/wiki/RF_GEMVal_Project/ERA5_Data/regERA5_SNDT_1991.nc','sd');
sw1992 = ncread('/home/sushama/wiki/RF_GEMVal_Project/ERA5_Data/regERA5_SNDT_1992.nc','sd');
sw1993 = ncread('/home/sushama/wiki/RF_GEMVal_Project/ERA5_Data/regERA5_SNDT_1993.nc','sd');
sw1994 = ncread('/home/sushama/wiki/RF_GEMVal_Project/ERA5_Data/regERA5_SNDT_1994.nc','sd');
sw1995 = ncread('/home/sushama/wiki/RF_GEMVal_Project/ERA5_Data/regERA5_SNDT_1995.nc','sd');
sw1996 = ncread('/home/sushama/wiki/RF_GEMVal_Project/ERA5_Data/regERA5_SNDT_1996.nc','sd');
sw1997 = ncread('/home/sushama/wiki/RF_GEMVal_Project/ERA5_Data/regERA5_SNDT_1997.nc','sd');
sw1998 = ncread('/home/sushama/wiki/RF_GEMVal_Project/ERA5_Data/regERA5_SNDT_1998.nc','sd');
sw1999 = ncread('/home/sushama/wiki/RF_GEMVal_Project/ERA5_Data/regERA5_SNDT_1999.nc','sd');
sw2000 = ncread('/home/sushama/wiki/RF_GEMVal_Project/ERA5_Data/regERA5_SNDT_2000.nc','sd');
sw2001 = ncread('/home/sushama/wiki/RF_GEMVal_Project/ERA5_Data/regERA5_SNDT_2001.nc','sd');
sw2002 = ncread('/home/sushama/wiki/RF_GEMVal_Project/ERA5_Data/regERA5_SNDT_2002.nc','sd');
sw2003 = ncread('/home/sushama/wiki/RF_GEMVal_Project/ERA5_Data/regERA5_SNDT_2003.nc','sd');
sw2004 = ncread('/home/sushama/wiki/RF_GEMVal_Project/ERA5_Data/regERA5_SNDT_2004.nc','sd');
sw2005 = ncread('/home/sushama/wiki/RF_GEMVal_Project/ERA5_Data/regERA5_SNDT_2005.nc','sd');
sw2006 = ncread('/home/sushama/wiki/RF_GEMVal_Project/ERA5_Data/regERA5_SNDT_2006.nc','sd');
sw2007 = ncread('/home/sushama/wiki/RF_GEMVal_Project/ERA5_Data/regERA5_SNDT_2007.nc','sd');
sw2008 = ncread('/home/sushama/wiki/RF_GEMVal_Project/ERA5_Data/regERA5_SNDT_2008.nc','sd');
sw2009 = ncread('/home/sushama/wiki/RF_GEMVal_Project/ERA5_Data/regERA5_SNDT_2009.nc','sd');
sw2010 = ncread('/home/sushama/wiki/RF_GEMVal_Project/ERA5_Data/regERA5_SNDT_2010.nc','sd');
sw2011 = ncread('/home/sushama/wiki/RF_GEMVal_Project/ERA5_Data/regERA5_SNDT_2011.nc','sd');
sw2012 = ncread('/home/sushama/wiki/RF_GEMVal_Project/ERA5_Data/regERA5_SNDT_2012.nc','sd');
sw2013 = ncread('/home/sushama/wiki/RF_GEMVal_Project/ERA5_Data/regERA5_SNDT_2013.nc','sd');
sw2014 = ncread('/home/sushama/wiki/RF_GEMVal_Project/ERA5_Data/regERA5_SNDT_2014.nc','sd');
sw2015 = ncread('/home/sushama/wiki/RF_GEMVal_Project/ERA5_Data/regERA5_SNDT_2015.nc','sd');
sw2016 = ncread('/home/sushama/wiki/RF_GEMVal_Project/ERA5_Data/regERA5_SNDT_2016.nc','sd');
sw2017 = ncread('/home/sushama/wiki/RF_GEMVal_Project/ERA5_Data/regERA5_SNDT_2017.nc','sd');
sw2018 = ncread('/home/sushama/wiki/RF_GEMVal_Project/ERA5_Data/regERA5_SNDT_2018.nc','sd');
sw2019 = ncread('/home/sushama/wiki/RF_GEMVal_Project/ERA5_Data/regERA5_SNDT_2019.nc','sd');
sw2020 = ncread('/home/sushama/wiki/RF_GEMVal_Project/ERA5_Data/regERA5_SNDT_2020.nc','sd');
...
apr_sep = cat(2,apr_sep1989,apr_sep1991,apr_sep1992,apr_sep1993,apr_sep1994,apr_sep1995,apr_sep1997,apr_sep1998,...
    apr_sep1999,apr_sep2000,apr_sep2001,apr_sep2003,apr_sep2004,apr_sep2005,apr_sep2006,apr_sep2007,apr_sep2009,...
    apr_sep2010,apr_sep2011,apr_sep2012,apr_sep2013,apr_sep2015,apr_sep2016,apr_sep2017,apr_sep2018,apr_sep2019);

testing = cat(2,apr_sep1990,apr_sep1996,apr_sep2002,apr_sep2008,apr_sep2014,apr_sep2020);
tag01d = testing-1;
...
sweq = cat(3,sweq1989,sweq1991,sweq1992,sweq1993,sweq1994,sweq1995,sweq1997,sweq1998,sweq1999,...
    sweq2000,sweq2001,sweq2003,sweq2004,sweq2005,sweq2006,sweq2007,sweq2009,...
    sweq2010,sweq2011,sweq2012,sweq2013,sweq2015,sweq2016,sweq2017,sweq2018,sweq2019);

sweq_t = cat(3,sweq1990,sweq1996,sweq2002,sweq2008,sweq2014,sweq2020);
...
hr_nd = movmean(hr(:,:,lag01d),[0,n]);
tt_nd = movmean(tt(:,:,lag01d),[0,n]);
smlt_nd = movmean(smlt(:,:,lag01d),[0,n]);
wa_nd = movmean(wav(:,:,lag01d),[0,n]);
...
tt_t01 = tt(:,:,tag01d);
wa_t01 = wav(:,:,tag01d);
smlt_t01 = smlt(:,:,tag01d);

hr_td = movmean(hr(:,:,tag01d),[0,n]);
tt_td = movmean(tt(:,:,tag01d),[0,n]);
smlt_td = movmean(smlt(:,:,tag01d),[0,n]);
wa_td = movmean(wav(:,:,tag01d),[0,n]);

clearvars a snd top cla apr_sep hr j lag01d march2004 sm smlt sweq2004 tag01d testing tt wav sw n 

%Define RF parameters
minLeafSize = 1000; %Define minimum leaf size here
numTrees = 1000; %Define number of trees here
ibf = 0.9; %Define in-bag fraction here

load('/home/sushama/wiki/RF_GEMVal_Project/aux/rotated.mat') %Load land-sea mask

%Define matrices
importance = zeros(110,69); %Will contain most important variable
importance2 = zeros(110,69);%Will contain 2nd most important variable
importance3 = zeros(110,69);%Will contain 3rd most important variable
models = {}; %Will contain trained models
sm_pred_test = zeros(110,69); %Will contain surface soil moisture prediction (SSM) from testing data
sm_pred_train = zeros(110,69);%Will contain surface soil moisture prediction from training data
predImp = zeros(7590,9);

%Naming convention for models and SSM predictions
vecstr = num2str(minLeafSize); 
name = strcat('RF2_ModGridCell_MLS',vecstr);
mls = strcat('MinLeafSize = ',32,vecstr);
workspc = strcat('/home/sushama/wiki/RF_GEMVal_Project/models/RFM_ModGridCell_MLS',vecstr,'.mat');
a = 0;

%This nested loop will check if the cell is land or sea
%If land, it will extract predictor data from that cell and train the model
for i = 1:110
    for j = 1:69
        
        if bbb(i,j)==1 %If land cell, it extracts data from predictors
            a = a+1;
            sm = squeeze(smo(i,j,:));
            hr_01 = squeeze(hr_1d(i,j,:));
            hr_02 = squeeze(hr_nd(i,j,:));
            sweqq = squeeze(sweq(i,j,:));
            tt_01 = squeeze(tt_1d(i,j,:));
            tt_02 = squeeze(tt_nd(i,j,:));
            wa_01 = squeeze(wa_1d(i,j,:));
            wa_02 = squeeze(wa_nd(i,j,:));
            smlt_01 = squeeze(smlt_1d(i,j,:));
            smlt_02 = squeeze(smlt_nd(i,j,:));

            sm_tt = squeeze(sm_t(i,j,:));
            hr_t1 = squeeze(hr_t01(i,j,:));
            hr_t2 = squeeze(hr_td(i,j,:));
            sweqq_t = squeeze(sweq_t(i,j,:));
            tt_t1 = squeeze(tt_t01(i,j,:));
            tt_t2 = squeeze(tt_td(i,j,:));
            wa_t1 = squeeze(wa_t01(i,j,:));
            wa_t2 = squeeze(wa_td(i,j,:));
            smlt_t1 = squeeze(smlt_t01(i,j,:));
            smlt_t2 = squeeze(smlt_td(i,j,:));

            %Arranges data in tables to train RF model
            %Training table
            T_training = table(sm,hr_01,hr_02,smlt_01,smlt_02,sweqq,tt_01,tt_02,wa_01,wa_02,...
            'VariableNames',{'sm','hr_l01','hr_lag','smlt_l01','smlt_lag','sweq','tt_l01','tt_lag','wa_l01','wa_lag'});

            %Testing table
            T_testing = table(sm_tt,hr_t1,hr_t2,smlt_t1,smlt_t2,sweqq_t,tt_t1,tt_t2,wa_t1,wa_t2,...
            'VariableNames',{'sm','hr_l01','hr_lag','smlt_l01','smlt_lag','sweq','tt_l01','tt_lag','wa_l01','wa_lag',});

            %Creates the RF model 
            forest = TreeBagger(numTrees,T_training,'sm','Method','regression','PredictorSelection','curvature','OOBPredictorImportance','on','MinLeafSize',minLeafSize,'InBagFraction',ibf);
            predImp(a,:) = forest.OOBPermutedPredictorDeltaError; %Saves predictor importance values
            impimp = forest.OOBPermutedPredictorDeltaError;
            [m,ind] = maxk(impimp,3);

            importance(i,j) = ind(1);
            importance2(i,j) = ind(2);
            importance3(i,j) = ind(3);
            cmp = compact(forest);
            models{i,j} = cmp; %Stores trained model for cell (i,j)

            %Uses RF model to predict SSM
            sm_predicted = squeeze(mean(predict(forest,T_testing)));
            sm_pred_test(i,j) = sm_predicted; %SSM prediction from testing data for cell (i,j)
            
            sm_predicted2 = squeeze(mean(predict(forest,T_training)));
            sm_pred_train(i,j) = sm_predicted2; %SSM prediction from training data for cell (i,j)
            
        elseif bbb(i,j)==0 %For sea cells, it stores NaN values
            a = a+1;
            sm_pred_test(i,j) = NaN;
            importance(i,j) = NaN;
            importance2(i,j) = NaN;
            importance3(i,j) = NaN;
            predImp(a,:) = nan(1,9);
            ...
            disp(strcat('mls= ',num2str(minLeafSize)))

    end
end

disp(strcat('Saving ',name,'_SavedModel','.mat'))
save(workspc,'predImp','importance','importance2','importance3','sm_pred_test','sm_pred_train') %Saves SSM predictions and importances
save(strcat('/home/sushama/wiki/RF_GEMVal_Project/models/',name,'_SavedModel','.mat'),'models','-v7.3') %Saves RF models